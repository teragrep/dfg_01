...
The actor calling the action needs to have `read` access to the `from_repository`. The default https://docs.github.com/en/actions/reference/workflows-and-actions/contexts#github-context[`github.token`] is used for downloading the releases.
